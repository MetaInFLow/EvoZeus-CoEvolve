...
python3 scripts/evozeus_wrapper.py harness migrate-layout --target /absolute/path/to/skill --latest-version v0.11.2 --dry-run --json
python3 scripts/evozeus_wrapper.py harness migrate-layout --target /absolute/path/to/skill --latest-version v0.11.2 --json
python3 scripts/evozeus_wrapper.py harness upgrade-all --latest-version v0.11.2 --dry-run --json
python3 scripts/evozeus_wrapper.py harness upgrade-all --latest-version v0.11.2 --approve --json
```
