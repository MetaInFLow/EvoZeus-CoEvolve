...
- The official PR workflow is suitable for a required check because it runs for every PR. The repository's externally configured `main` ruleset remains the merge gate; changing workflow YAML cannot weaken that external rule.
