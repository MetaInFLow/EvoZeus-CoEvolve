...
- Preserve unknown existing files at managed destinations. User confirmation alone cannot supply ownership evidence; require an exact trusted preimage or manifest receipt before refresh.
